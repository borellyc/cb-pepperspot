...
struct gengetopt_args_info
{
  ...
  char *pidfile_arg;             //!< Filename of process id file (default='/var/run/pepper.pid')
  ...
  char *ipversion_orig;          //!< Allowed version of IP (default='6') value given at command line
  char *statedir_arg;            //!< Directory of nonvolatile data (default='/var/lib/pepper/')
  ...
  char *uamserver6_orig;         //!< IPv6 UAM server authentication original value given at command line
  ...
  char *uamsecret_orig;          //!< Shared secret between uamserver and pepper original value given at command line
