...
cmdline_parser_print_help (void)
{
  ...
  printf("%s\n","      --uamserver6=STRING       IPv6 URL of authentication web server  \n                                  (default=`https://login.hotradius.com')");
  printf("%s\n","      --uamhomepage=STRING      URL of homepage to redirect unauthenticated \n                                  users to");
  printf("%s\n","      --uamsecret=STRING        Shared secret between uamserver and pepper");
...
cmdline_parser_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->staticipv6_given) {
    if (args_info->staticipv6_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "staticipv6", args_info->staticipv6_orig);
    } else {
      fprintf(outfile, "%s\n", "staticipv6");
    }
  }
  if (args_info->ipv6prefix_given) {
    if (args_info->ipv6prefix_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "ipv6prefix", args_info->ipv6prefix_orig);
    } else {
      fprintf(outfile, "%s\n", "ipv6prefix");
    }
  }
  ...
  if (args_info->dhcplisten_given) {
    if (args_info->dhcplisten_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "dhcplisten", args_info->dhcplisten_orig);
    } else {
      fprintf(outfile, "%s\n", "dhcplisten");
    }
  }
  ...
  if (args_info->uamserver6_given) {
    if (args_info->uamserver6_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "uamserver6", args_info->uamserver6_orig);
    } else {
      fprintf(outfile, "%s\n", "uamserver6");
    }
  }
      ...
      switch (c)
        ...
        case 0:  /* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "ipversion") == 0)
          {
            ...
            if (args_info->ipversion_given && ! override)
              continue;
          ...
          else if (strcmp (long_options[option_index].name, "staticipv6") == 0)
          {
            ...
            if (args_info->staticipv6_given && ! override)
              continue;
         ...
         /* IPv6 prefix */
         else if (strcmp (long_options[option_index].name, "ipv6prefix") == 0)
          {
            ...
            if (args_info->ipv6prefix_given && ! override)
              continue;
          ...
          else if (strcmp (long_options[option_index].name, "dhcplisten") == 0)
          {
            ...
            if (args_info->dhcplisten_given && ! override)
              continue;
          ...
          else if (strcmp (long_options[option_index].name, "uamserver6") == 0)
          {
            ...
            if (args_info->uamserver6_given && ! override)
              continue;
...
cmdline_parser_configfile (char * const filename, struct gengetopt_args_info *args_info, int override, int initialize, int check_required)
{
  ...
  result = cmdline_parser_internal (my_argc, my_argv_arg, args_info, override, initialize, check_required, additional_error);
