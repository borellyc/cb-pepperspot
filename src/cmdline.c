...
static int cmdline_parser_internal(int argc, char *const *argv,
...
static void clear_given(struct gengetopt_args_info *args_info) {
  ...
  args_info->staticipv6_given = 0;
  args_info->ipv6prefix_given = 0;
...
static void clear_args(struct gengetopt_args_info *args_info) {
  ...
  args_info->conf_arg = gengetopt_strdup("/etc/pepper.conf");
  args_info->conf_orig = NULL;
  args_info->interval_arg = 3600;
  args_info->interval_orig = NULL;
  args_info->pidfile_arg = gengetopt_strdup("/var/run/pepper.pid");
  args_info->pidfile_orig = NULL;
  args_info->ipversion_arg = gengetopt_strdup("ipv6");
  args_info->ipversion_orig = NULL;
  args_info->statedir_arg = gengetopt_strdup("/var/lib/pepper/");
  ...
  args_info->staticipv6_arg = gengetopt_strdup("2001:db8:1::1234");
  ...
  args_info->uamserver6_arg = NULL; // MUST be specified in configuration file
                                    // with IPv6 address (with brackets)
...
void cmdline_parser_print_help(void) {
  ...
  printf("\n%s\n", "Copyright 2002-2005 Mondru AB\nPepperSpot is an Open "
                   "Source captive portal or wireless LAN access "
                   "point\ncontroller developed by the community at "
                   "pepperspot.info and licensed under\nthe GPL. PepperSpot "
                   "acknowledges all community members, especially\nthose "
                   "mentioned at http://www.pepperspot.info/credits.html.");
  ...
  printf("%s\n", "      --debugfacility=INT       Which modules to print "
                 "debug messages for  \n                                  "
                 "(default=`1')");
  printf("%s\n", "  -c, --conf=STRING             Read configuration file  \n "
                 "                                 "
                 "(default=`/etc/pepper.conf')");
  printf("%s\n", "      --interval=INT            Re-read configuration file "
                 "at this interval  \n                                  "
                 "(default=`3600')");
  printf("%s\n", "      --pidfile=STRING          Filename of process id file "
                 " \n                                  "
                 "(default=`/var/run/pepper.pid')");
  printf("%s\n", "      --ipversion=STRING         Allowed version of "
                 "Internet Protocol \n              (default=`ipv6`)");
  printf("%s\n", "      --statedir=STRING         Directory of nonvolatile "
                 "data  \n                                  "
  ...
  printf("%s\n", "      --staticipv6=STRING       IPv6 adress to listen to  "
                 "(default='2001:db8:1::1234')");
  printf("%s\n", "       --ipv6prefix=STRING       IPv6 prefix    "
                 "(default='2001:db8:1::/64')");
  printf("%s\n", "      --domain=STRING           Domain to use for DNS "
                 "lookups  \n                                  "
  ...
  printf("%s\n", "      --radiusserver1=STRING    IP address of radius server "
                 "1  \n                                  "
                 "(default=`rad01.hotradius.com')");
  printf("%s\n", "      --radiusserver2=STRING    IP address of radius server "
                 "2  \n                                  "
                 "(default=`rad02.hotradius.com')");
  printf("%s\n", "      --radiusauthport=INT      Authentication UDP port of "
                 "radius server  \n                                  "
                 "(default=`1812')");
  printf("%s\n", "      --radiusacctport=INT      Accounting UDP port of "
                 "radius server  \n                                  "
                 "(default=`1813')");
  printf("%s\n", "      --radiussecret=STRING     Radius shared secret");
  printf("%s\n", "      --radiusnasid=STRING      Radius NAS-Identifier  "
                 "(default=`nas01')");
  ...
  printf("%s\n", "      --coaport=INT             Radius disconnect port to "
                 "listen to  \n                                  "
                 "(default=`0')");
  printf("%s\n", "      --coanoipcheck            Allow radius disconnect "
                 "from any IP  \n                                  "
                 "(default=off)");
  ...
  printf("%s\n", "      --dhcplisten=STRING      IPv6 adresse for listenning");
  printf("%s\n", "      --lease=INT               Lease time to allocate to "
                 "clients  \n                                  "
                 "(default=`600')");
  printf("%s\n", "      --eapolenable             Enable IEEE 802.1x "
                 "authentication  \n                                  "
                 "(default=off)");
  printf("%s\n", "      --uamserver=STRING        URL of authentication web "
                 "server  \n                                  "
                 "(default=`https://login.hotradius.com')");
  printf("%s\n", "      --uamserver6=STRING       IPv6 URL of authentication "
                 "web server  \n                                  "
                 "(default=`https://login.hotradius.com')");
  printf("%s\n", "      --uamhomepage=STRING      URL of homepage to redirect "
                 "unauthenticated \n                                  users "
                 "to");
  printf("%s\n", "      --uamsecret=STRING        Shared secret between "
                 "uamserver and pepper");
  printf("%s\n", "      --uamlisten=STRING        IP address to listen to for "
                 "authentication \n                                  "
                 "requests");
  printf("%s\n", "      --uamport=INT             TCP port to bind to for "
                 "authentication requests \n                                  "
                 " (default=`3990')");
  printf("%s\n", "      --uamallowed=STRING       Domain names exempt from "
                 "access check ");
  printf("%s\n", "      --uamanydns               Allow client to use any DNS "
                 "server  \n                                  (default=off)");
  printf("%s\n", "      --macauth                 Authenticate based on MAC "
                 "address  \n                                  (default=off)");
  printf("%s\n",
         "      --macallowed=STRING       List of allowed MAC addresses");
  printf("%s\n",
         "      --macsuffix=STRING        Suffix to add to the MAC address");
  printf("%s\n", "      --macpasswd=STRING        Password used when "
                 "performing MAC \n                                  "
...
int cmdline_parser_file_save(const char *filename,
  ...
  if (args_info->version_given) { fprintf(outfile, "%s\n", "version"); }
  if (args_info->fg_given) { fprintf(outfile, "%s\n", "fg"); }
  if (args_info->debug_given) { fprintf(outfile, "%s\n", "debug"); }
  ...
  if (args_info->ipversion_given) {
    if (args_info->ipversion_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "pidfile", args_info->ipversion_orig);
    } else {
      fprintf(outfile, "%s\n", "pidfile");
    }
  }
  ...
  if (args_info->staticipv6_given) {
    if (args_info->staticipv6_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "staticipv6",
              args_info->staticipv6_orig);
    } else {
      fprintf(outfile, "%s\n", "staticipv6");
    }
  }
  if (args_info->ipv6prefix_given) {
    if (args_info->ipv6prefix_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "ipv6prefix",
              args_info->ipv6prefix_orig);
    } else {
      fprintf(outfile, "%s\n", "ipv6prefix");
    }
  }
  ...
  if (args_info->uamserver6_given) {
    if (args_info->uamserver6_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "uamserver6",
              args_info->uamserver6_orig);
    } else {
      fprintf(outfile, "%s\n", "uamserver6");
    }
  }
  ...
  if (args_info->uamallowed_orig) {
    for (i = 0; i < args_info->uamallowed_given; ++i) {
      if (args_info->uamallowed_orig[i]) {
        fprintf(outfile, "%s=\"%s\"\n", "uamallowed",
                args_info->uamallowed_orig[i]);
      }
    }
  }
  if (args_info->uamanydns_given) { fprintf(outfile, "%s\n", "uamanydns"); }
  if (args_info->macauth_given) { fprintf(outfile, "%s\n", "macauth"); }
  if (args_info->macallowed_orig) {
    for (i = 0; i < args_info->macallowed_given; ++i) {
      if (args_info->macallowed_orig[i]) {
        fprintf(outfile, "%s=\"%s\"\n", "macallowed",
                args_info->macallowed_orig[i]);
      }
    }
  }
...
int cmdline_parser2(int argc, char *const *argv,
  ...
  result = cmdline_parser_internal(argc, argv, args_info, override, initialize,
                                   check_required, NULL);
...
int cmdline_parser_internal(int argc, char *const *argv,
                            struct gengetopt_args_info *args_info,
  ...
  while (1) {
    ...
    case 'h': // Print help and exit.
      ...
      if (initialize) { cmdline_parser_free(args_info); }
      exit(EXIT_SUCCESS);
    ...
    case 'f': // Run in foreground.
      ...
      if (args_info->fg_given && !override) continue;
    ...
    case 'd': // Run in debug mode.
      ...
      if (args_info->debug_given && !override) continue;
    ...
    case 'c': // Read configuration file.
      ...
      if (args_info->conf_given && !override) continue;
    ...
    case 'n': // Network.
      ...
      if (args_info->net_given && !override) continue;
      local_args_info.net_given = 1;
      args_info->net_given = 1;
      if (args_info->net_arg) free(args_info->net_arg); // free previous string
    ...
    case 0: // Long option with no short option
      ...
      if (strcmp(long_options[option_index].name, "debugfacility") == 0) {
        if (local_args_info.debugfacility_given) {
          fprintf(stderr,
                  "%s: `--debugfacility' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->debugfacility_given && !override) continue;
      ...
      // Re-read configuration file at this interval.
        ...
        if (args_info->interval_given && !override) continue;
      ...
      // Filename of process id file.
        ...
        if (args_info->pidfile_given && !override) continue;
      ...
      // Filename of process id file.
        ...
        if (local_args_info.ipversion_given) {
          fprintf(stderr, "%s: `--ipversion' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->ipversion_given && !override) continue;
      ...
      // Directory of nonvolatile data.
        ...
        if (args_info->statedir_given && !override) continue;
      ...
      // Dynamic IP address pool.
        ...
        if (args_info->dynip_given && !override) continue;
      ...
      // Static IP address pool.
        ...
        if (args_info->statip_given && !override) continue;
      ...
      // Primary DNS server IP address.
        ...
        if (args_info->dns1_given && !override) continue;
      ...
      // Secondary DNS server IP address.
        ...
        if (args_info->dns2_given && !override) continue;
      ...
      // Static ipv6 to listen to
        ...
        if (args_info->staticipv6_given && !override) continue;
      ...
      // IPv6 prefix
        ...
        if (args_info->ipv6prefix_given && !override) continue;
      ...
      // Domain to use for DNS lookups.
        ...
        if (args_info->domain_given && !override) continue;
      ...
      // Script to run after link-up.
        ...
        if (args_info->ipup_given && !override) continue;
      ...
      // Script to run after link-down.
        ...
        if (args_info->ipdown_given && !override) continue;
      ...
      // Script to run after user logon.
        ...
        if (args_info->conup_given && !override) continue;
      ...
      // Script to run after user logoff.
        ...
        if (args_info->condown_given && !override) continue;
      ...
      // IP address to send from.
        ...
        if (local_args_info.radiuslisten_given) {
          fprintf(stderr,
                  "%s: `--radiuslisten' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiuslisten_given && !override) continue;
      ...
      // IP address of radius server 1.
        ...
        if (local_args_info.radiusserver1_given) {
          fprintf(stderr,
                  "%s: `--radiusserver1' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiusserver1_given && !override) continue;
      ...
      // IP address of radius server 2.
        ...
        if (local_args_info.radiusserver2_given) {
          fprintf(stderr,
                  "%s: `--radiusserver2' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiusserver2_given && !override) continue;
      ...
      else if (strcmp(long_options[option_index].name, "radiusauthport") ==
               0) {
        if (local_args_info.radiusauthport_given) {
          fprintf(stderr,
                  "%s: `--radiusauthport' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiusauthport_given && !override) continue;
      ...
      else if (strcmp(long_options[option_index].name, "radiusacctport") ==
               0) {
        if (local_args_info.radiusacctport_given) {
          fprintf(stderr,
                  "%s: `--radiusacctport' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiusacctport_given && !override) continue;
      ...
      // Radius shared secret.
        ...
        if (local_args_info.radiussecret_given) {
          fprintf(stderr,
                  "%s: `--radiussecret' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiussecret_given && !override) continue;
      ...
      // Radius NAS-Identifier.
        ...
        if (local_args_info.radiusnasid_given) {
          fprintf(stderr,
                  "%s: `--radiusnasid' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiusnasid_given && !override) continue;
      ...
      // Radius NAS-IP-Address.
        ...
        if (local_args_info.radiusnasip_given) {
          fprintf(stderr,
                  "%s: `--radiusnasip' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiusnasip_given && !override) continue;
      ...
      // Radius Called-Station-ID.
        ...
        if (local_args_info.radiuscalled_given) {
          fprintf(stderr,
                  "%s: `--radiuscalled' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiuscalled_given && !override) continue;
      ...
      // WISPr Location ID.
      else if (strcmp(long_options[option_index].name, "radiuslocationid") ==
               0) {
        if (local_args_info.radiuslocationid_given) {
          fprintf(stderr,
                  "%s: `--radiuslocationid' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiuslocationid_given && !override) continue;
      ...
      // WISPr Location Name.
      else if (strcmp(long_options[option_index].name, "radiuslocationname") ==
               0) {
        if (local_args_info.radiuslocationname_given) {
          fprintf(stderr,
                  "%s: `--radiuslocationname' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiuslocationname_given && !override) continue;
      ...
      else if (strcmp(long_options[option_index].name, "radiusnasporttype") ==
               0) {
        if (local_args_info.radiusnasporttype_given) {
          fprintf(stderr,
                  "%s: `--radiusnasporttype' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->radiusnasporttype_given && !override) continue;
      ...
      // Radius disconnect port to listen to.
        ...
        if (args_info->coaport_given && !override) continue;
      ...
      // Allow radius disconnect from any IP.
        ...
        if (local_args_info.coanoipcheck_given) {
          fprintf(stderr,
                  "%s: `--coanoipcheck' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->coanoipcheck_given && !override) continue;
      ...
      // IP address to listen to.
        ...
        if (local_args_info.proxylisten_given) {
          fprintf(stderr,
                  "%s: `--proxylisten' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->proxylisten_given && !override) continue;
      ...
      // UDP port to listen to.
        ...
        if (args_info->proxyport_given && !override) continue;
      ...
      // IP address of proxy client(s).
        ...
        if (local_args_info.proxyclient_given) {
          fprintf(stderr,
                  "%s: `--proxyclient' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->proxyclient_given && !override) continue;
      ...
      // Radius proxy shared secret.
        ...
        if (local_args_info.proxysecret_given) {
          fprintf(stderr,
                  "%s: `--proxysecret' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->proxysecret_given && !override) continue;
      ...
      // Username for remote config.
        ...
        if (local_args_info.confusername_given) {
          fprintf(stderr,
                  "%s: `--confusername' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->confusername_given && !override) continue;
      ...
      // Password for remote config.
        ...
        if (local_args_info.confpassword_given) {
          fprintf(stderr,
                  "%s: `--confpassword' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->confpassword_given && !override) continue;
      ...
      // Local Ethernet interface.
        ...
        if (args_info->dhcpif_given && !override) continue;
      ...
      // Interface MAC address.
        ...
        if (args_info->dhcpmac_given && !override) continue;
      ...
      // dhcplisten
        ...
        if (local_args_info.dhcplisten_given) {
          fprintf(stderr, "%s: `--dhcplisten' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->dhcplisten_given && !override) continue;
      ...
      // Lease time to allocate to clients.
        ...
        if (args_info->lease_given && !override) continue;
      ...
      // Enable IEEE 802.1x authentication.
        ...
        if (local_args_info.eapolenable_given) {
          fprintf(stderr,
                  "%s: `--eapolenable' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->eapolenable_given && !override) continue;
      ...
      // URL of authentication web server.
        ...
        if (args_info->uamserver_given && !override) continue;
      ...
      // IPv6 URL of authentication web server.
        ...
        if (local_args_info.uamserver6_given) {
          fprintf(stderr, "%s: `--uamserver6' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->uamserver6_given && !override) continue;
      ...
      // URL of homepage to redirect unauthenticated users to.
        ...
        if (local_args_info.uamhomepage_given) {
          fprintf(stderr,
                  "%s: `--uamhomepage' option given more than once%s\n",
                  argv[0], (additional_error ? additional_error : ""));
          goto failure;
        }
        if (args_info->uamhomepage_given && !override) continue;
      ...
      // Shared secret between uamserver and pepper.
        ...
        if (args_info->uamsecret_given && !override) continue;
      ...
      // IP address to listen to for authentication requests.
        ...
        if (args_info->uamlisten_given && !override) continue;
      ...
      // TCP port to bind to for authentication requests.
        ...
        if (args_info->uamport_given && !override) continue;
      ...
      // Domain names exempt from access check .
        ...
        while (1) {
          uamallowed_new =
              (struct uamallowed_list *)malloc(sizeof(struct uamallowed_list));
      ...
      // Allow client to use any DNS server.
        ...
        if (args_info->uamanydns_given && !override) continue;
      ...
      // Authenticate based on MAC address.
        ...
        if (args_info->macauth_given && !override) continue;
      ...
      // List of allowed MAC addresses.
        ...
        while (1) {
          macallowed_new =
              (struct macallowed_list *)malloc(sizeof(struct macallowed_list));
      ...
      // Suffix to add to the MAC address.
        ...
        if (args_info->macsuffix_given && !override) continue;
      ...
      // Password used when performing MAC authentication.
        ...
        if (args_info->macpasswd_given && !override) continue;
  ...
  if (local_args_info.uamallowed_given && uamallowed_list) {
    ...
    args_info->uamallowed_arg = (char **)realloc(
        args_info->uamallowed_arg,
        (args_info->uamallowed_given + local_args_info.uamallowed_given) *
            sizeof(char *));
    args_info->uamallowed_orig = (char **)realloc(
        args_info->uamallowed_orig,
        (args_info->uamallowed_given + local_args_info.uamallowed_given) *
            sizeof(char *));
    for (i = (local_args_info.uamallowed_given - 1); i >= 0; --i) {
      tmp = uamallowed_list;
      args_info->uamallowed_arg[i + args_info->uamallowed_given] =
          uamallowed_list->uamallowed_arg;
      args_info->uamallowed_orig[i + args_info->uamallowed_given] =
          uamallowed_list->uamallowed_orig;
  ...
  if (local_args_info.macallowed_given && macallowed_list) {
    ...
    args_info->macallowed_arg = (char **)realloc(
        args_info->macallowed_arg,
        (args_info->macallowed_given + local_args_info.macallowed_given) *
            sizeof(char *));
    args_info->macallowed_orig = (char **)realloc(
        args_info->macallowed_orig,
        (args_info->macallowed_given + local_args_info.macallowed_given) *
            sizeof(char *));
    for (i = (local_args_info.macallowed_given - 1); i >= 0; --i) {
      tmp = macallowed_list;
      args_info->macallowed_arg[i + args_info->macallowed_given] =
          macallowed_list->macallowed_arg;
      args_info->macallowed_orig[i + args_info->macallowed_given] =
          macallowed_list->macallowed_orig;
...
int cmdline_parser_configfile(char *const filename,
  ...
  result =
      cmdline_parser_internal(my_argc, my_argv_arg, args_info, override,
                              initialize, check_required, additional_error);
